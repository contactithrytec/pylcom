...
"code_site" => "Site Code",
"machine_voltage" => "Machine voltage",
...
"exit_time" => "Exit Time",
"work_hour" => "Work Hour",
"total_travel_time_go" => "Total travel time one way",
"total_travel_time_return" => "Total return travel time",
"kilometers_go" => "kilometers one way",
"kilometers_return" => "kilometers return",
"compressor_time" => "Compressor time",
"machine_time" => "Machine time",
"date_work" => "Date",
"hotel" => "Hotel",
"problem_solving" => "Problem solving",
"air_out" => "AIR CONDITIONING OUT SERVICE",
"good" => "GOOD",
"reference" => "Material used (Reference)",
"designation" => "designation",
"air_on" => "AIR CONDITIONING ON",
