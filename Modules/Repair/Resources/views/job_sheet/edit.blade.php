                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('code_site', $job_sheet->code_site, ['class' => 'form-control', 'placeholder' => __('repair::lang.code_site'), 'required']); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('serial_no', __('repair::lang.serial_no') . ':') !!}
                            {!! Form::text('serial_no', $job_sheet->serial_no, ['class' => 'form-control', 'placeholder' => __('repair::lang.serial_no'),]); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('device_model_id', __('repair::lang.device_model') . ':*') !!}
                            {!! Form::select('device_model_id', $device_models, $job_sheet->device_model_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('machine_voltage', __('repair::lang.machine_voltage') . ':') !!}
                            {!! Form::text('machine_voltage',  $job_sheet->machine_voltage, ['class' => 'form-control', 'placeholder' => __('repair::lang.machine_voltage')]); !!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <label class="radio-inline">
                            {!! Form::radio('service_type', 'curative', ($job_sheet->service_type == 'curative') ? true : false, [ 'class' => 'input-icheck', 'required']); !!}
                            @lang('repair::lang.curative')
                        </label>
                        <label class="radio-inline">
                            {!! Form::radio('service_type', 'preventive', ($job_sheet->service_type == 'preventive') ? true : false, [ 'class' => 'input-icheck']); !!}
                            @lang('repair::lang.preventive')
                        </label>
                        <label class="radio-inline radio_btns">
                            {!! Form::radio('service_type', 'installation_', ($job_sheet->service_type == 'installation') ? true : false, [ 'class' => 'input-icheck']); !!}
                            @lang('repair::lang.installation')
                        </label>
                        <label class="radio-inline radio_btns">
                            {!! Form::radio('service_type', 'uninstallation', ($job_sheet->service_type == 'uninstallation') ? true : false, [ 'class' => 'input-icheck']); !!}
                            @lang('repair::lang.uninstallation')
                        </label>
                        <label class="radio-inline radio_btns">
                            {!! Form::radio('service_type', 'installation_ats', ($job_sheet->service_type == 'installation_ats') ? true : false, [ 'class' => 'input-icheck']); !!}
                    ...
                    @if(in_array('service_staff' ,$enabled_modules))
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('service_staff2', $technecians, $job_sheet->service_staff2, ['class' => 'form-control select2', 'placeholder' => __('restaurant.select_service_staff')]); !!}
                            </div>
                        </div>
                    @endif
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="work_hour" name="work_hour" value="{{$job_sheet->work_hour}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('entry_time', __('repair::lang.entry_time') . ':') !!}
                            <input type="time" class="form-control" id="entry_time" name="entry_time" value="{{$job_sheet->entry_time}}">                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('exit_time', __('repair::lang.exit_time') . ':') !!}
                            <input type="time" class="form-control" id="exit_time" name="exit_time" value="{{$job_sheet->exit_time}}">                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('total_travel_time_go', __('repair::lang.total_travel_time_go') . ':') !!}
                            <input type="number" class="form-control" id="total_travel_time_go" name="total_travel_time_go" value="{{$job_sheet->total_travel_time_go}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('total_travel_time_return', __('repair::lang.total_travel_time_return') . ':') !!}
                            <input type="number" class="form-control" id="total_travel_time_return" name="total_travel_time_return" value="{{$job_sheet->total_travel_time_return}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('kilometers_go', __('repair::lang.kilometers_go') . ':') !!}
                            <input type="number" class="form-control" id="kilometers_go" name="kilometers_go" value="{{$job_sheet->kilometers_go}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('kilometers_return', __('repair::lang.kilometers_return') . ':') !!}
                            <input type="number" class="form-control" id="kilometers_return" name="kilometers_return" value="{{$job_sheet->kilometers_return}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('hotel', __('repair::lang.hotel') . ':') !!}
                            {!! Form::text('hotel', $job_sheet->hotel, ['class' => 'form-control', 'placeholder' => __('repair::lang.hotel'),]); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('date_work', __('repair::lang.date_work') . ':*') !!}
                            <input type="date" class="form-control" id="date_work" name="date_work" required value="{{$job_sheet->date_work}}">
                        </div>
                    </div>
                </div>
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="compressor">{{__('repair::lang.compressor') . ':*'}}</label>
                            <select name="compressor" class="form-control status" id="compressor" required>
                                <option @if($job_sheet->compressor =="brand") selected @endif value="brand">{{__('repair::lang.brand')}}</option>
                                <option @if($job_sheet->compressor =="voltage") selected @endif value="voltage">{{__('repair::lang.voltage')}}</option>
                                <option @if($job_sheet->compressor =="gas") selected @endif value="gas">{{__('repair::lang.gas')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('test_alarms', $job_sheet->test_alarms , ['class' => 'form-control', 'placeholder' => __('repair::lang.test_alarms'),]); !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('machine_time', __('repair::lang.machine_time') . ':') !!}
                            <input type="time" class="form-control" id="machine_time" name="machine_time" value="{{$job_sheet->machine_time}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('compressor_time', __('repair::lang.compressor_time') . ':') !!}
                            <input type="time" class="form-control" id="compressor_time" name="compressor_time" value="{{$job_sheet->compressor_time}}">                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('defects', __('repair::lang.defects') . ':') !!} <br>
                            {!! Form::textarea('defects', $job_sheet->defects, ['class' => 'tags-look', 'rows' => 3]); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('problem_solving', __('repair::lang.problem_solving') . ':') !!} <br>
                            {!! Form::textarea('problem_solving', $job_sheet->problem_solving , ['class' => 'form-control', 'rows' => 3]); !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('product_condition', $job_sheet->product_condition, ['class' => 'tags-look', 'rows' => 3]); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('reference', $job_sheet->reference, ['class' => 'form-control ', 'rows' => '3']); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('designation', __('repair::lang.designation') . ':') !!}
                            {!! Form::textarea('designation',  $job_sheet->designation, ['class' => 'form-control ', 'rows' => '3']); !!}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('customer_observation', $job_sheet->customer_observation, ['class' => 'form-control']); !!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('supervisor_name', $job_sheet->supervisor_name, ['class' => 'form-control']); !!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('signature', $job_sheet->signature, ['class' => 'form-control']); !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <span class="input-group-addon">
                                ...
                                {!! Form::text('delivery_date', $job_sheet->delivery_date, ['class' => 'form-control', 'readonly']); !!}
                                <span class="input-group-addon">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('Warranty', $job_sheet->Warranty, ['class' => 'form-control']); !!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('Out_Warranty', $job_sheet->Out_Warranty, ['class' => 'form-control']); !!}
                        </div>
                    </div>
