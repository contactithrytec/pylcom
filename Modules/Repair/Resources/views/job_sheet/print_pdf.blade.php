...
<div class="width-100 box mb-10">
	<table class="no-border table-pdf">
		<tr>
			...
			<th>@lang('repair::lang.product_configuration'):</th>
		...
		<td colspan="2" style="vertical-align: top;">
			<table class="width-100">
				...
				<tr>
					...
					<th>@lang('repair::lang.code_site'):</th>
					<td>{{$job_sheet->code_site}}</td>
				</tr>
				<tr>
					<th>@lang('repair::lang.serial_no'):</th>
					<td >{{$job_sheet->serial_no}}</td>
					<th>@lang('repair::lang.machine_voltage'):</th>
					<td>{{$job_sheet->machine_voltage}}</td>
				</tr>
				<tr>
	...
	<table class="table-pdf">
		<tr>
			<td style="vertical-align: top;">
				<table class="width-100">
					<tr>
						<th style="padding-left: 0;">@lang('repair::lang.compressor')</th>
					</tr>
					<tr>
						<td style="padding-left: 0; padding-top: -5">
							<p>
								<b>@lang('repair::lang.brand'):</b><br>
								{{$job_sheet->brand_comp}}
								<br>
								<b>@lang('repair::lang.voltage'):</b><br>
								{{$job_sheet->voltage_comp}}
								<br>
								<b>@lang('repair::lang.gas'):</b><br>
								{{$job_sheet->gas_comp}}
			...
			<td colspan="2" style="vertical-align: top;">
				<table class="width-100">
					<tr>
						<th>@lang('repair::lang.detector_test'):</th>
						<td>{{$job_sheet->detector_test}}</td>
						<th>@lang('repair::lang.test_alarms'):</th>
						<td>{{$job_sheet->test_alarms}}</td>
					</tr>
					<tr>
						<th>@lang('repair::lang.compressor_time'):</th>
						<td>{{$job_sheet->compressor_time}}</td>
						<th>@lang('repair::lang.machine_time'):</th>
						<td>{{$job_sheet->machine_time}}</td>
					</tr>
					<tr>
						<th>@lang('repair::lang.total_travel_time_go'):</th>
						<td >{{$job_sheet->total_travel_time_go}}</td>
						<th>@lang('repair::lang.total_travel_time_return'):</th>
						<td>{{$job_sheet->total_travel_time_return}}</td>
					</tr>
					<tr>
						<th>@lang('repair::lang.kilometers_go'):</th>
						<td >{{$job_sheet->kilometers_go}}</td>
						<th>@lang('repair::lang.kilometers_return'):</th>
						<td>{{$job_sheet->kilometers_return}}</td>
					</tr>
					<tr>
						<th>@lang('repair::lang.hotel'):</th>
						<td >{{$job_sheet->hotel}}</td>
						<th>@lang('repair::lang.date_work'):</th>
						<td>{{$job_sheet->date_work}}</td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td style="padding-top: 0">
				<strong>@lang('repair::lang.work_hour'):</strong>
				<br>
				{{$job_sheet->work_hour}}
			</td>
			<td style="padding-top: 0">
				<strong>@lang('repair::lang.entry_time'):</strong>
				{{$job_sheet->entry_time}}
		    </td>
			<td style="padding-top: 0">
				<strong>@lang('repair::lang.exit_time'):</strong>
				{{$job_sheet->exit_time}}
			</td>
		</tr>
	</table>
...
<div class="width-100 content-div">
	<strong>@lang('repair::lang.problem_solving'):</strong>
...
<div class="width-100 content-div">
	<strong>@lang('repair::lang.reference'):</strong>
	{{$job_sheet->reference}}
</div>
<div class="width-100 content-div">
	<strong>@lang('repair::lang.designation'):</strong>
...
<div class="width-100 content-div">
	@if(!empty($job_sheet->customer_observation))
	<div class="width-50 f-left mb-5">
		<strong>{{ __('repair::lang.customer_observation')}}:</strong>
	     {{$job_sheet->customer_observation}}
	</div>
	@endif
	@if(!empty($job_sheet->supervisor_name))
	<div class="width-50 f-left mb-5">
			<strong>{{ __('repair::lang.supervisor_name')}}:</strong>
			{{$job_sheet->supervisor_name}}
	</div>
	@endif
	@if(!empty($job_sheet->Warranty))
	<div class="width-50 f-left">
		<strong>{{__('repair::lang.Warranty')}}:</strong>
		{{$job_sheet->Warranty}}
	</div>
	@endif
	@if(!empty($job_sheet->Out_Warranty))
	<div class="width-50 f-left mb-5">
		<strong>{{ __('repair::lang.Out_Warranty')}}:</strong>
		{{$job_sheet->Out_Warranty}}
	</div>
	@endif
	{{--@if(!empty($job_sheet->custom_field_5))
	<div class="width-50 f-left mb-5">
		<strong>{{ __('repair::lang.custom_field')}}:</strong>
...
<table class="table-pdf">
	<tr>
		...
		<td><strong>@lang('repair::lang.technician') 1:</strong> {{optional($job_sheet->technician)->user_full_name}}</td>
		<th>@lang('repair::lang.authorized_signature') 2:</th>
		<td><strong>@lang('repair::lang.technician'):</strong> {{optional($job_sheet->technician2)->user_full_name}}</td>
	</tr>
</table>
