    ...
    <div class="login-form col-md-12 col-xs-12 right-col-content">
        ...
        <form method="POST" action="{{ route('login') }}" id="login-form">
            ...
            <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}">
                ...
                @endphp
                <input id="username" type="text" class="form-control" name="username" value="{{ $username }}" required autofocus placeholder="@lang('lang_v1.username')" style="border-radius: 10px;">
            ...
            <div class="form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                value="{{ $password }}" required placeholder="@lang('lang_v1.password')" style="border-radius: 10px;">
            ...
            <br>
            <div class="form-group">
                <button type="submit" class="btn btn-flat btn-login" style="border-radius: 10px;background-color:#9f9eff">@lang('lang_v1.login')</button>
                @if(config('app.env') != 'demo')
