...
<!------------------------------------ADDED------------------------------->
          ...
          <div class="col-md-4">
              <div class="form-group">
                  {!! Form::label('RC', 'RC' . ':') !!}
                  {!! Form::text('RC', $contact->RC, ['class' => 'form-control', 'placeholder' => 'RC']); !!}
              </div>
          </div>
          <div class="col-md-4">
              <div class="form-group">
                  {!! Form::label('NIS', 'NIS' . ':') !!}
                  {!! Form::text('NIS', $contact->NIS, ['class' => 'form-control', 'placeholder' => 'NIS']); !!}
              </div>
          </div>
          <div class="col-md-4">
              <div class="form-group">
                  {!! Form::label('NIF', 'NIF' . ':') !!}
                  {!! Form::text('NIF', $contact->NIF, ['class' => 'form-control', 'placeholder' => 'NIF']); !!}
              </div>
          </div>
<!------------------------------------ADDED------------------------------->
