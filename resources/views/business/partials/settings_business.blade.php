...
<!-------------------------added--------------------------------------------->
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('RC','RC' . ':') !!}
                {!! Form::text('RC', $business->RC, ['class' => 'form-control','placeholder' => 'RC']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('NIS','NIS' . ':') !!}
                {!! Form::text('NIS', $business->NIS, ['class' => 'form-control', 'placeholder' => 'NIS']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('RIB','RIB' . ':') !!}
                {!! Form::text('RIB', $business->RIB, ['class' => 'form-control', 'placeholder' => 'RIB']); !!}
            </div>
        </div>
        <div class="clearfix"></div>
<!-------------------------added--------------------------------------------->
