...
<div class="row" style="color: #000000 !important;">
	...
	<div class="col-xs-12 text-center">
		...
		@endif
			{{--------------ADD ----------------------}}
		@if(!empty($receipt_details->RC))
				<br>
					<b >RC: </b>{!! $receipt_details->RC !!}
			@endif
			@if(!empty($receipt_details->NIS))
				<br>
					 <b >NIS: </b>{!! $receipt_details->NIS !!}
			@endif
			@if(!empty($receipt_details->RIB))
				<br>
				<b >RIB: </b>{!! $receipt_details->RIB !!}
			@endif
			{{--------------ADD ----------------------}}
		...
		<p style="width: 100% !important" class="word-wrap">
			<span class="pull-left text-left word-wrap">
				...
				@endif
					{{--------------ADD ----------------------}}
					@if(!empty($receipt_details->customer_RC))
						<b>RC : </b> {!! $receipt_details->customer_RC !!}
					@endif
					@if(!empty($receipt_details->customer_NIS))
						<br>
						<b>NIS : </b>{!! $receipt_details->customer_NIS !!}
					@endif
					@if(!empty($receipt_detailss->customer_NIF))
						<br>
						<b>NIF : </b> {!! $receipt_details->customer_NIF !!}
					@endif
					{{--------------ADD ----------------------}}
