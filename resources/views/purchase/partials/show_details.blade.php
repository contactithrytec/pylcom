  ...
  <div class="row invoice-info">
    <div class="col-sm-4 invoice-col">
      ...
      <address>
        ...
        @endif
{{------------------------------------------added--------------------------------------------}}
      @if(!empty($purchase->contact->RC))
          <br>
          <b>RC :</b> {!! $purchase->contact->RC !!}
        @endif
        @if(!empty($purchase->contact->NIS))
          <br>
          <b>NIS :</b>{!! $purchase->contact->NIS !!}
        @endif
        @if(!empty($purchase->contact->NIF))
          <br>
          <b>NIF :</b> {!! $purchase->contact->NIF !!}
        @endif
{{------------------------------------------end added--------------------------------------------}}
      </address>
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <address>
        ...
        @endif
        {{------------------------------------------added--------------------------------------------}}
        @if(!empty($purchase->business->RC))
          <br>
          RC : {!! $purchase->business->RC !!}
        @endif
        @if(!empty($purchase->business->NIS))
          <br>
          NIS :{!! $purchase->business->NIS !!}
        @endif
        @if(!empty($purchase->business->RIB))
          <br>
          RIB : {!! $purchase->business->RIB !!}
        @endif
        {{------------------------------------------end added--------------------------------------------}}
      </address>
    </div>
