		...
		<div class="modal-body">
			...
			<div class="row invoice-info">
				<div class="col-sm-4 invoice-col">
			        ...
			        @endif
						 {{--------------ADD ----------------------}}
						 @if(!empty($stock_adjustment->business->RC))
							 <br>
							 <b >RC: </b>{!! $stock_adjustment->business->RC !!}
						 @endif
						 @if(!empty($stock_adjustment->business->NIS))
							 <br>
							 <b >NIS: </b>{!! $stock_adjustment->business->NIS !!}
						 @endif
						 @if(!empty($stock_adjustment->business->RIB))
							 <br>
							 <b >RIB: </b>{!! $stock_adjustment->business->RIB !!}
						 @endif
						 {{--------------ADD ----------------------}}
			      </address>
			    </div>
