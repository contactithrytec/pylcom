				...
				<div class="row invoice-info">
				  <div class="col-sm-4 invoice-col">
				    ...
				    <address>
				      ...
				      @endif
						{{--------------ADD ----------------------}}
						@if(!empty($info_sell->RC))
							<br>
							<b >RC: </b>{!! $info_sell->RC !!}
						@endif
						@if(!empty($info_sell->NIS))
							<br>
							<b >NIS: </b>{!! $info_sell->NIS !!}
						@endif
						@if(!empty($info_sell->RIB))
							<br>
							<b >RIB: </b>{!! $info_sell->RIB !!}
						@endif
						{{--------------ADD ----------------------}}
				  ...
				  <div class="col-md-4 invoice-col">
				    ...
				    <address>
				      ...
				      @endif
						{{--------------ADD ----------------------}}
						@if(!empty($info_purchase->RC))
							<br>
							<b >RC: </b>{!! $info_purchase->RC !!}
						@endif
						@if(!empty($info_purchase->NIS))
							<br>
							<b >NIS: </b>{!! $info_purchase->NIS !!}
						@endif
						@if(!empty($info_purchase->RIB))
							<br>
							<b >RIB: </b>{!! $info_purchase->RIB !!}
						@endif
						{{--------------ADD ----------------------}}
